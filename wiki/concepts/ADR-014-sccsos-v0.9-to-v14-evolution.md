...
v0.8.1 完成基础可观测性（EventBus/Supervisor/Config）后，SCCS OS 从最小可用产品进入**能力完善和商业化就绪**阶段。本 ADR 覆盖 v0.9.0~v0.14.2 共 8 个版本的架构决策，跨越会话持久化、多模型路由、前端控制台、安全审计、企业级计费、技能市场、K8s 部署等关键进化。
