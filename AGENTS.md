...
>
> **当前版本**: v0.16.5 (2026-07-26)
> **架构基线**: Python ~24K 逻辑行 + Vue 3 SPA (7 页面) + 测试 1158 用例 / 77 文件 / 176+ 测试类
> **健康评分**: 8.8/10 (12 维度)  [P0 安全修复: injection+ratelimit 接线, Dockerfiles 同步 | P1 CLI 文件拆分: hermes_cmd 1276→685行]
> **许可证**: MIT
...
| **文档知识库** | ADR 覆盖所有版本 v0.9.0~v0.16.5 | P0 |
