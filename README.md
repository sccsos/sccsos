...
```bash
# 全合一镜像（Hermes 内嵌）
docker build -t sccsos:0.20.2 -f Dockerfile .
docker run -d -p 8765:8765 sccsos:0.20.2
...
| 版本 | 日期 | 关键特性 |
|------|------|---------|
| v0.20.2 | 2026-07-25 | `_find_hermes_bin_dir` 新增，安装后自动补充 PATH 确保 config-sync 可用 |
